...
import Taskhistory from "./2Employee/Taskhistory";
// Navigation items
const NAVIGATION = [
  {
    segment: "overview", title: "Overview", icon: <TuneIcon />,
  },
  { segment: "pendingtasks", title: "Pending Tasks", icon: <WorkHistoryIcon /> },
  {
    segment: "completedtasks", title: "Completed Tasks", icon: <EditCalendarIcon />,
  },
  {
    segment: "approvaltasks", title: "Approval Tasks", icon: <CheckCircleIcon />,
    // children: [
    //   {
    //     segment: "financial",
    ...
    //   },
    //   {
    //     segment: "task reports",
    //     title: "Task Reports",
    //     icon: <DescriptionIcon />,
    //   },
    // ],
  },
  { segment: "taskhistory", title: "Task History", icon: <RestoreIcon /> },
  { segment: "deadline", title: "Deadline", icon: < HourglassBottomIcon /> },
];
...
const themeWithCustomColors = createTheme({
  palette: {
    primary: { main: "#1995AD" },
    secondary: { main: "#A1D6E2" },
    background: { default: "#F1F1F2" },
  },
});
...
export default function EmployeeDashBoard() {
  ...
  const renderContent = () => {
    switch (selectedSegment) {
      case "overview":
        return <Typography paragraph>Overview</Typography>;
      case "pendingtasks":
        return <Typography paragraph>pendingtasks</Typography>;
      case "completedtasks":
        return <Typography paragraph>completedtasks</Typography>;
      case "approvaltasks":
        return <Typography paragraph>approvaltasks</Typography>;
      case "taskhistory":
        return <Typography paragraph><Taskhistory/></Typography>;
      default:
        return <Typography paragraph>deadline</Typography>;
    }
  };
